...
public class ItemBuilder extends BaseItemBuilder<ItemBuilder> {
    ...
    public static SkullBuilder skull(@NotNull final EntityType entityType) {
        return new SkullBuilder().mob(entityType);
    }
     ...
     * @return {@link ItemBuilder}
     * @deprecated In favor of , nothing changed just the name, will be removed in 3.0.1
     */
    @Deprecated
